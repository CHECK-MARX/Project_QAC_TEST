...
#if defined (__QACPP_MAJOR__) && (__QACPP_MAJOR__ <= 70)
...
#  define __has_trivial_destructor __qacpp_has_trivial_destructor
#  define __is_assignable __qacpp_is_assignable
#  define __is_constructible __qacpp_is_constructible
#  define __is_destructible __qacpp_is_destructible
#  define __is_nothrow_assignable __qacpp_is_nothrow_assignable
#  define __is_nothrow_constructible __qacpp_is_nothrow_constructible
#  define __is_nothrow_destructible __qacpp_is_nothrow_destructible
#  define __is_trivially_constructible __qacpp_is_trivially_constructible
#  define __is_trivially_destructible __qacpp_is_trivially_destructible
#  define __is_trivially_assignable __qacpp_is_trivially_assignable
